        ...
        call.enqueue(new Callback<Rss>() {
            ...
            public void onResponse(Response<Rss> response, Retrofit retrofit) {
                if(response.isSuccess()) {
                    ...
                    Toast.makeText(getApplicationContext(),"Load RSS Failed", Toast.LENGTH_LONG).show();
                }
            }
...
//    }
    public void onEvent( Rss response ){
        Toast.makeText( this, response.getChannel().getItem().get(1).getTitle(), Toast.LENGTH_LONG ).show();
